...
inline bool IsStochasticFstInLog(const Fst<StdArc> &fst,
  ...
  bool ans = false;
  LogArc::Weight log_min = LogArc::Weight::One(), // fst::FloatLimits<LogArc::Weight::ValueType>::PosInfinity(),
    log_max = LogArc::Weight::Zero(); // fst::FloatLimits<LogArc::Weight::ValueType>::NegInfinity();
  if (fst.Type() == "const") {
